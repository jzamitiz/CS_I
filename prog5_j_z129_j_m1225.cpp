...
either the input file or the output file fails to open.
   ...
   Sample File Output (file - prog5_?out.txt): //'?' - students' lect sec #
...
void getName ( string &, string &, string &, string & );
string getLectureSection ( );
void getLabSection ( string &, string & );
void printIdInfo ( ostream &, string, string, string, string, const string,
...
void getName ( string &first1_name, string &last1_name, string &first2_name,
               string &last2_name )
{
...
void printIdInfo ( ostream &out, string first1_name, string last1_name,
                   string first2_name, string last2_name, const string CLASS,
                   string lecture_section, string lab_section1,
                   string lab_section2, const string DUE_DATE )
{
   out << first1_name << " " << last1_name << " & " << first2_name
       << " " << last2_name << endl
...
void readExpression ( ifstream &fin, double &operand1, char &operatr,
                      double &operand2 )
{
...
void echoExpression ( ofstream &fout, double operand1, char operatr,
                      double operand2 )
{
...
void evaluateExpression ( ofstream &fout, double operand1, char operatr,
                          double operand2 )
{
   switch ( operatr )
   {
